...
export function VideoRoom({
    ...
    // Use tenant prop (from backend) or fallback to env var
    const APP_ID = tenant || process.env.NEXT_PUBLIC_JITSI_APP_ID;
...
`.trim();
    ...
    return (
        <div className="h-screen w-full bg-slate-900 relative overflow-hidden">
            ...
            {!jwt && (
                <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 bg-red-500/10 border border-red-500/50 text-red-500 px-4 py-2 rounded-lg backdrop-blur-md">
                    <p className="text-sm font-medium">
                        Auth Error: No Jitsi Token. Check Server Logs.
                    </p>
                </div>
            )}
            ...
            <JitsiMeeting
                ...
                configOverwrite={{
                    ...
                    // Use Tile View by default to ensure self-visibility when alone
                ...
                interfaceConfigOverwrite={{
                    ...
                    TOOLBAR_BUTTONS: [
                        ...
                        "tileview",
                        "invite",
                        "recording", // Added recording button
                        "whiteboard",
                    ],
